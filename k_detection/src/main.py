...
if __name__ == '__main__':  # TODO -> render multiprocess 
    ...
    table.add_row("silhouette", "higher is better")
    table.add_row("calinski harabasz", "higher is better")
    table.add_row("dunn", "higher is better")
    table.add_row("pearson", "higher is better")
    table.add_row("avg", "lower is better")
    table.add_row("separation index", "higher is better")
    table.add_row("entropy", "higher is better")
    table.add_row("wwcg", "lower is better")
    table.add_row("cvnn", "lower is better")
    console.print(table)
    ...
    for l in range(0,2):
        ...
        if l == 1:
            cosine = True
            console.print("COSINE__DISTANCE", style="green", width=25)
        else:
            console.print("EUCLIDEAN__DISTANCE", style="green", width=25)
